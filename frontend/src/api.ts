...
export const API_BASE_URL = (import.meta as any).env?.VITE_API_URL || 'http://localhost:5010';
export const AI_BASE_URL = (import.meta as any).env?.VITE_AI_URL || 'http://localhost:8010';
